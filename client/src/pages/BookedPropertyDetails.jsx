...
import { ReceiptLong, Close, Print, CalendarMonth, CreditCard, QueryBuilder, Bookmark, EventAvailable, EventBusy, PaymentOutlined } from "@mui/icons-material";
...
const BookedPropertyDetails = () => {
    ...
    return (
      <>
        ...
        <div className="listing-details">
          <h2>Booking details not found or still loading. Please try again later.</h2>
        </div>
        <Footer />
      </>
    );
  ...
  return (
    <>
      ...
      <div className="listing-details">
        <div className="title">
          <h1>{listing.title || 'Property Details'}</h1>
          <div></div>
        </div>
            ...
            <div className="profile">
              {listing.creator.profileImagePath ? (
                ...
                <div className="profile-placeholder">
                  {(listing.creator.firstName && listing.creator.firstName[0]) || 'H'}
                </div>
              )}
              <h3>
                Hosted by {listing.creator.firstName && listing.creator.lastName ? 
                  ...
                  (listing.hostId?.firstName && listing.hostId?.lastName ? 
                    `${listing.hostId.firstName} ${listing.hostId.lastName}` : 
                    'Shree Hari Rental Property Host')}
              </h3>
            </div>
            <hr />
          </>
